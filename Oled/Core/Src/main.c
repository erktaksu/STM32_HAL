...
#include "stdio.h" //c kütüphanesi
#include "ssd1306.h" //ekranın kütüphanesi
#include "fonts.h" //fonts kütüphanesi
...
/* Private variables ---------------------------------------------------------*/
ADC_HandleTypeDef hadc1;  // adc okuması için

I2C_HandleTypeDef hi2c1; //ekran için
